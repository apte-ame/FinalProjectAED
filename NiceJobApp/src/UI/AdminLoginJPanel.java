...
public class AdminLoginJPanel extends javax.swing.JPanel {
    ...
    public AdminLoginJPanel(JSplitPane splitPane, String choice, Connection conn) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblAdminLoginDesk = new javax.swing.JLabel();
        ...
        lblAdminLoginDesk.setFont(new java.awt.Font("Trebuchet MS", 1, 30)); // NOI18N
        lblAdminLoginDesk.setForeground(new java.awt.Color(255, 255, 255));
        lblAdminLoginDesk.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblAdminLoginDesk.setText("Admin Login Desk");
        ...
        lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Admin small title.png"))); // NOI18N
        ...
        kGradientPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnBack, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, kGradientPanel1Layout.createSequentialGroup()
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(lblLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 334, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                .addGap(106, 106, 106)
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(lblAdminLoginDesk, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
        ...
        kGradientPanel1Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
                        .addGap(135, 135, 135)
                        .addComponent(lblAdminLoginDesk)
                        .addGap(18, 18, 18)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(username.equalsIgnoreCase(txtUsername.getText()) && choice.equalsIgnoreCase("university admin")){
            if(password.equalsIgnoreCase(new String(passwordField.getPassword())) || masterPassword.equals(new String(passwordField.getPassword()))){
                    SystemAdminUniversityJPanel nextPanel = new SystemAdminUniversityJPanel(splitPane, conn);
                    splitPane.setRightComponent(nextPanel);
            }else{
                JOptionPane.showMessageDialog(this, "Password incorrect. Please try again.");
            }
        }else if(username.equalsIgnoreCase(txtUsername.getText()) && choice.equalsIgnoreCase("company admin")){
            if(password.equalsIgnoreCase(new String(passwordField.getPassword())) || masterPassword.equals(new String(passwordField.getPassword()))){
                    SystemAdminCompanyJPanel nextPanel = new SystemAdminCompanyJPanel(splitPane, conn);
                    splitPane.setRightComponent(nextPanel);
            }else{
                JOptionPane.showMessageDialog(this, "Password incorrect. Please try again.");
            }
        }else if(username.equalsIgnoreCase(txtUsername.getText()) && choice.equalsIgnoreCase("government admin")){
            if(password.equalsIgnoreCase(new String(passwordField.getPassword())) || masterPassword.equals(new String(passwordField.getPassword()))){
                    SystemAdminGovernmentJPanel nextPanel = new SystemAdminGovernmentJPanel(splitPane, conn);
                    splitPane.setRightComponent(nextPanel);
            }else{
                JOptionPane.showMessageDialog(this, "Password incorrect. Please try again.");
            }
        }else if(username.equalsIgnoreCase(txtUsername.getText()) && choice.equalsIgnoreCase("rental admin")){
            if(password.equalsIgnoreCase(new String(passwordField.getPassword())) || masterPassword.equals(new String(passwordField.getPassword()))){
                    SystemAdminHousingJPanel nextPanel = new SystemAdminHousingJPanel(splitPane, conn);
                    splitPane.setRightComponent(nextPanel);
            }else{
                JOptionPane.showMessageDialog(this, "Password incorrect. Please try again.");
            }
        }else{
            JOptionPane.showMessageDialog(this, "Username incorrect. Please try again.");
        }
    ...
    private javax.swing.JLabel lblAdminLoginDesk;
